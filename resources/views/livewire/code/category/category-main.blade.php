<div class="bg-white shadow rounded-xl mx-4">
    ...
    <div class="flex flex-row justify-between items-center py-4 bg-green-600 rounded-t-lg">
        ...
        <div class="px-4">
            <a href="{{ route('codecategory.create') }}" class="text-white text-sm sm:text-md rounded-lg py-2 px-4 bg-black hover:bg-slate-600 transition duration-1000 ease-in-out" title="Create New Category">New</a>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
                    ...
                    <tbody>
                        ...
                        @foreach ($categories as $category)
                            <tr class="even:bg-zinc-200 odd:bg-white transition-all duration-1000 hover:bg-yellow-400">
                                ...
                                <td class="p-2 whitespace-nowrap text-md leading-6 font-medium text-gray-900">{{ $category->name }}</td>
                                ...
                                <td class="p-2">
                                    <div class="flex justify-center items-center gap-4">
                                        ...
                                        {{-- <a href="{{ route('codecategory.entries', $category) }}" title="See Entries for this category">
            ...
            @else
                <div class="bg-zinc-200 py-6 rounded-lg border-double border-2 border-red-600">
                    <span class="text-md text-red-600 px-4">No categories found
