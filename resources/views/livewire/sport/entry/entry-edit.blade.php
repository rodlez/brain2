    ...
    <form wire:submit="save">
        ...
        <div class="flex flex-row justify-start items-end py-6 px-4 sm:px-16 gap-4 bg-orange-300">
            ...
            <div>
                <label class="inline-flex items-center cursor-pointer">
                    <input wire:model="status" name="status" id="status" type="checkbox" value="{{ $entry->status }}" {{ $entry->status == 1 ? 'checked' : '' }} class="sr-only peer">
        ...
        <div class="py-0 px-4 sm:mx-12">
            ...
            <div class="flex flex-row justify-start items-center gap-4">
                ...
                <input wire:model="date" name="date" id="date" type="date" min="2024-01-01" value="{{ old('date') }}" class="w-full pl-4 p-2 text-md rounded-lg bg-gray-50 border border-gray-300 text-gray-900 dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:ring-orange-500 focus:border-orange-500">
            </div>
        </div>
        <div class="py-2 px-20 sm:mx-12 text-red-600 font-semibold">
            @error('date')
        ...
        <div class="py-0 px-4 sm:mx-12">
            ...
            <div class="flex flex-row justify-start items-center gap-4">
                ...
                <input wire:model="location" name="location" id="location" type="text" value="{{ old('location') }}" class="w-full pl-4 p-2 text-md rounded-lg bg-gray-50 border border-gray-300 text-gray-900 dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:ring-orange-500 focus:border-orange-500">
            </div>
        </div>
        <div class="py-2 px-20 sm:mx-12 text-red-600 font-semibold">
            @error('location')
