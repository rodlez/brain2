...
<x-app-layout>
    <div class="container max-w-6xl mx-auto px-6 py-4">
        ...
        <div class="flex flex-row justify-start items-center py-2 px-2 text-slate-400">
            ...
            <a href="/dashboard/code/tag" class="px-2 hover:text-green-600">Tags</a> /
            <a href="/dashboard/code/tag/{{ $tag->id }}" class="px-2 font-bold text-black border-b-2 border-b-green-500">Info</a>
        </div>
        ...
        <div class="bg-white shadow rounded-xl mx-4">
            ...
            <div class="mx-auto w-11/12 py-4 px-2">
                ...
                <div class="flex flex-row justify-start items-center gap-4 py-2">
                    ...
                    <input type="text" id="name" class="bg-zinc-200 border border-zinc-300 text-gray-900 text-md rounded-lg w-full sm:w-1/2 pl-4 p-2  dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" value="{{ $tag->name }}" disabled>
                    <!-- Edit -->
