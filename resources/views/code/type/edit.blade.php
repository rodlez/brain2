...
<x-app-layout>
    <div class="container max-w-6xl mx-auto px-6 py-4">
        ...
        <div class="flex flex-row justify-start items-center py-2 px-2 text-slate-400">
            ...
            <a href="/dashboard/code/type/{{ $type->id }}" class="px-2 hover:text-green-600">Info</a> /
            <a href="/dashboard/code/type/edit/{{ $type->id }}" class="px-2 font-bold text-black border-b-2 border-b-green-500">Edit</a>
        </div>
