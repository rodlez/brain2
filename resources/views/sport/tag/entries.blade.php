...
<x-app-layout>
    <div class="container max-w-6xl mx-auto px-6 py-4">
        ...
        <div class="flex flex-row justify-start items-center py-4 px-2 text-slate-400">
            ...
            <a href="/dashboard/sport/tag/{{ $tag->id }}/entries" class="px-2 font-bold text-black border-b-2 border-b-orange-500">Sports</a>
        </div>
        <livewire:sport.tag.tag-entries :tag="$tag" />
    </div>
