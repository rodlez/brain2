...
<x-app-layout>
    <div class="container max-w-6xl mx-auto px-6 py-4">
        ...
        <div class="flex flex-row justify-start items-center py-4 px-2 text-slate-400">
            ...
            <a href="/dashboard/sport/tag/edit/{{ $tag->id }}" class="px-2 font-bold text-black border-b-2 border-b-orange-500">Edit</a>
        </div>
        ...
        <div class="bg-white shadow rounded-xl">
            ...
            <form action="{{ route('sporttag.update', $tag) }}" method="POST">
                ...
                <div class="py-6 px-4">
                    ...
                    <input name="name" id="name" type="text" value="{{ $tag->name }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg w-2/3 pl-4 p-2  dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500">
                </div>
                <!-- Errors -->
