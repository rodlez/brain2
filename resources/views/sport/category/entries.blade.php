...
<x-app-layout>
    <div class="container max-w-6xl mx-auto px-6 py-4">
        ...
        <div class="flex flex-row justify-start items-center py-4 px-2 text-slate-400">
            ...
            <a href="/dashboard/sport/category" class="px-2 hover:text-orange-500">Categories</a> /
            <a href="/dashboard/sport/category/{{ $category->id }}/entries" class="px-2 font-bold text-black border-b-2 border-b-orange-500">Sports</a>
        </div>
        <livewire:sport.category.category-entries :category="$category" />
    </div>
