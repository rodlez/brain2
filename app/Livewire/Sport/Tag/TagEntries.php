...
class TagEntries extends Component
{
    ...
    public function mount()
    {
        ...
        $initialEntries = $this->tag->sports();
    ...
    public function render()
    {
        ...
        $entries = $this->tag->sports()->select(
        ...
        $categories = $this->tag->sports()->select(
        ...
        return view('livewire.sport.tag.tag-entries', [
            'entries'       => $entries,
            'found'         => $found,
            'total'         => $totalEntries,
